...
import { CredencialesDialog } from "../auth/CredencialesDialog";
                      ...
                      {empleados.map((empleado) => (
                        <Card key={empleado.id} className="p-4">
                          <div className="flex items-start justify-between gap-2 mb-2">
                            <p className="font-medium">{empleado.nombreApellido}</p>
                            <Badge variant={empleado.estado === "Activo" ? "default" : "secondary"}>
                              {empleado.estado}
                            </Badge>
                          </div>
                          <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
                            <p><span className="text-gray-400">DNI:</span> {empleado.dni}</p>
                            <p><span className="text-gray-400">Legajo:</span> {empleado.legajo}</p>
                            <p><span className="text-gray-400">Rol:</span> {empleado.rol}</p>
                            <p><span className="text-gray-400">Tel:</span> {empleado.telefono}</p>
                            <p className="col-span-2 truncate"><span className="text-gray-400">Email:</span> {empleado.mail}</p>
                          </div>
                        </Card>
                      ))}
                    </div>
